...
// interface ItemHandler, TagHandler, GroupHandler, LibraryEntryHandler, and
// PersonHandler depend on, since those are the entities with a bulk-delete
// endpoint per docs/adr/0016-bulk-operations.md.
