...
export default () => {
  ...
  res = http.post(`${SERVICE}/GetEntryPerson`, JSON.stringify({ libraryEntryId: libraryEntryId, personId: personId, role: role }), HEADERS);
  check(res, {
  ...
  res = http.post(`${SERVICE}/ListEntryPeople`, JSON.stringify({ libraryEntryId: libraryEntryId, pageSize: 10 }), HEADERS);
  check(res, {
  ...
  res = http.post(`${SERVICE}/DeleteEntryPerson`, JSON.stringify({ libraryEntryId: libraryEntryId, personId: personId, role: role }), HEADERS);
