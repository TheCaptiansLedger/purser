...
export default () => {
  ...
  res = invoke(`${SERVICE}/GetTagAssignment`, JSON.stringify({ tagId: tagId, entityType: entityType, entityId: entityId }), HEADERS);
  check(res, {
  ...
  res = invoke(`${SERVICE}/ListTagAssignments`, JSON.stringify({ tagId: tagId, pageSize: 10 }), HEADERS);
  check(res, {
  ...
  res = invoke(`${SERVICE}/ListTagAssignments`, JSON.stringify({ entityType: entityType, entityId: entityId, pageSize: 10 }), HEADERS);
  check(res, {
  ...
  res = invoke(`${SERVICE}/DeleteTagAssignment`, JSON.stringify({ tagId: tagId, entityType: entityType, entityId: entityId }), HEADERS);
  ...
  res = invoke(`${SERVICE}/ListTagAssignments`, JSON.stringify({ tagId: bulkTagId, pageSize: 10 }), HEADERS);
  check(res, {
  ...
  res = invoke(`${SERVICE}/GetTagAssignment`, JSON.stringify({ tagId: bulkTagId, entityType: 'ENTITY_TYPE_ITEM', entityId: 'k6-bulk-scene-4' }), HEADERS);
  ...
  for (const eid of bulkEntityIds) {
    res = invoke(`${SERVICE}/DeleteTagAssignment`, JSON.stringify({ tagId: bulkTagId, entityType: 'ENTITY_TYPE_ITEM', entityId: eid }), HEADERS);
