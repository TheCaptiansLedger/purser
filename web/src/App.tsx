...
// /music/artists/:id (#666), and the /settings/* admin area (#596). No
// other module (AfterDark/Acquisition/Pipeline) or other Music screen
// (Album Detail, Wanted board) exists yet.
