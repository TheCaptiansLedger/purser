...
func TestRepository_ItemPersonRepositoryContract_Badger(t *testing.T) {
...
func TestRepository_ItemPersonRepositoryContract_SQL(t *testing.T) {
	itempersontest.TestItemPersonRepository(t, func(t *testing.T) ports.ItemPersonRepository {
		return newRepository(t, newSQLDatastore(t))
	})
}

func newRepository(t *testing.T, ds datastore.Datastore) ports.ItemPersonRepository {
	t.Helper()
	repo, err := itemperson.New("test", ds)
	if err != nil {
