...
const (
	...
	GroupServiceName = "purser.domain.v1.GroupService"
)
...
const (
	...
	// RPC.
	GroupServiceCreateGroupProcedure = "/purser.domain.v1.GroupService/CreateGroup"
	// GroupServiceGetGroupProcedure is the fully-qualified name of the GroupService's GetGroup RPC.
	GroupServiceGetGroupProcedure = "/purser.domain.v1.GroupService/GetGroup"
	// GroupServiceUpdateGroupProcedure is the fully-qualified name of the GroupService's UpdateGroup
	// RPC.
	GroupServiceUpdateGroupProcedure = "/purser.domain.v1.GroupService/UpdateGroup"
...
func NewGroupServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) GroupServiceClient {
	...
	groupServiceMethods := v1.File_purser_domain_v1_group_proto.Services().ByName("GroupService").Methods()
...
// GetGroup calls purser.domain.v1.GroupService.GetGroup.
...
// UpdateGroup calls purser.domain.v1.GroupService.UpdateGroup.
...
// DeleteGroup calls purser.domain.v1.GroupService.DeleteGroup.
...
// ListGroups calls purser.domain.v1.GroupService.ListGroups.
...
func (UnimplementedGroupServiceHandler) CreateGroup(context.Context, *connect.Request[v1.CreateGroupRequest]) (*connect.Response[v1.CreateGroupResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("purser.domain.v1.GroupService.CreateGroup is not implemented"))
}
...
func (UnimplementedGroupServiceHandler) GetGroup(context.Context, *connect.Request[v1.GetGroupRequest]) (*connect.Response[v1.GetGroupResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("purser.domain.v1.GroupService.GetGroup is not implemented"))
}
...
func (UnimplementedGroupServiceHandler) UpdateGroup(context.Context, *connect.Request[v1.UpdateGroupRequest]) (*connect.Response[v1.UpdateGroupResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("purser.domain.v1.GroupService.UpdateGroup is not implemented"))
}
...
func (UnimplementedGroupServiceHandler) DeleteGroup(context.Context, *connect.Request[v1.DeleteGroupRequest]) (*connect.Response[v1.DeleteGroupResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("purser.domain.v1.GroupService.DeleteGroup is not implemented"))
}
