...
export default () => {
  ...
  res = client.invoke('purser.domain.v1.TagAssignmentService/BulkCreateTagAssignments', {
    tagId: bulkTagId,
  ...
  res = client.invoke('purser.domain.v1.TagAssignmentService/ListTagAssignments', { tagId: bulkTagId, pageSize: 10 });
  check(res, {
  ...
  res = client.invoke('purser.domain.v1.TagAssignmentService/GetTagAssignment', { tagId: bulkTagId, entityType: 'ENTITY_TYPE_ITEM', entityId: 'k6-bulk-scene-4' });
  ...
  for (const eid of bulkEntityIds) {
    res = client.invoke('purser.domain.v1.TagAssignmentService/DeleteTagAssignment', { tagId: bulkTagId, entityType: 'ENTITY_TYPE_ITEM', entityId: eid });
