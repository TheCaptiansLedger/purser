...
export default () => {
  ...
  res = client.invoke('purser.domain.v1.GroupService/GetGroupDeletionImpact', { id: id });
  check(res, {
  ...
  res = client.invoke('purser.domain.v1.ItemService/GetItem', { id: itemId });
  check(res, {
  ...
  res = client.invoke('purser.domain.v1.ItemService/DeleteItem', { id: itemId });
