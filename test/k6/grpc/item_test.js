...
export default () => {
  ...
  res = invoke('purser.domain.v1.ItemService/UpdateItem', {
  ...
  res = invoke('purser.domain.v1.ItemService/ListItems', { pageSize: 10 });
  check(res, {
  ...
  res = invoke('purser.domain.v1.ItemService/ListItems', { libraryEntryId: 'entry1', contentType: 'adult', pageSize: 10 });
  check(res, {
  ...
  res = invoke('purser.domain.v1.ItemService/ListItems', { libraryEntryId: 'no-such-entry', pageSize: 10 });
  check(res, {
  ...
  res = invoke('purser.domain.v1.ItemService/DeleteItem', { id: id });
  ...
  res = invoke('purser.domain.v1.ItemService/BulkDeleteItems', { ids: [bulkId3, 'k6-grpc-item-missing'] });
  ...
  res = invoke('purser.domain.v1.ItemService/DeleteItem', { id: bulkId3 });
