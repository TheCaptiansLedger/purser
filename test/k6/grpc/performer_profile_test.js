...
export default () => {
  ...
  let res = invoke('purser.afterdark.v1.PerformerProfileService/CreatePerformerProfile', {
  ...
  res = invoke('purser.afterdark.v1.PerformerProfileService/GetPerformerProfile', { personId: personId });
  check(res, {
  ...
  res = invoke('purser.afterdark.v1.PerformerProfileService/UpdatePerformerProfile', {
  ...
  res = invoke('purser.afterdark.v1.PerformerProfileService/ListPerformerProfiles', { pageSize: 10 });
  check(res, {
